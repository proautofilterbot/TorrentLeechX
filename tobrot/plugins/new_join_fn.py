    ...
    if chat_type != "private":
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton('🧠 𝐎𝐖𝐍𝐄𝐑 𝐎𝐅 𝐁𝐎𝐓 🧠', url='https://t.me/mhd_thanzeer')
                    ]
                ]
               )
            )
